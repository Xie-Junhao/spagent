...
| **Qwen Image Edit** | Image | Instruction-based Image Editing & Fusion | API (no server) | Qwen Image through DashScope; requires `DASHSCOPE_API_KEY`; supports 1-3 input images and 1-6 outputs |
