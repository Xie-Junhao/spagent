...
| `test_infinidepth_tool.py` | InfiniDepth tool mock tests and optional live server smoke test |
...
# Test InfiniDepth mock tests
python -m pytest -q test/test_infinidepth_tool.py
